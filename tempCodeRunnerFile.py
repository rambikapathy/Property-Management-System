...
def main_window():
    ...
    # Label and display current date and time on application main window
    ...
    tk.Label(window, text="", bg="white").pack()
    ...
    # Exit
    tk.Button(window, text="Close Window", width=20, height=2, command=window.destroy).pack(pady=10)
